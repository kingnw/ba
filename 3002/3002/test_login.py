...
class AuthTestCase(unittest.TestCase):
    def setUp(self):
        ...
        # Set up the app configuration before creating the test client
        self.app = app
    ...
    def test_successful_login(self):
        ...
        # Assert that the login was successful and the flash message is correct
        self.assertIn(b"Logged in successfully.", response.data)
        self.assertIn(b"Welcome testuser", response.data)  # Ensure the user is welcomed
        self.assertEqual(response.status_code, 200)
